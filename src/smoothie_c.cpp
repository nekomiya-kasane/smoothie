...
const char *smoothie_error_message(smoothie_error_code code) {
    ...
    case SMOOTHIE_OK:
        return "ok";
    case SMOOTHIE_ERROR_NOT_FOUND:
        return "not found";
    case SMOOTHIE_ERROR_CORRUPTED:
        return "corrupted data";
    case SMOOTHIE_ERROR_MMAP_FAILED:
        return "memory map failed";
    case SMOOTHIE_ERROR_VERSION_MISMATCH:
        return "version mismatch";
    case SMOOTHIE_ERROR_ALREADY_MOUNTED:
        return "already mounted";
    case SMOOTHIE_ERROR_NOT_MOUNTED:
        return "not mounted";
    case SMOOTHIE_ERROR_IO:
        return "I/O error";
    case SMOOTHIE_ERROR_INVALID_ARGUMENT:
        return "invalid argument";
    case SMOOTHIE_ERROR_BUFFER_TOO_SMALL:
        return "buffer too small";
    case SMOOTHIE_ERROR_NULL_POINTER:
        return "null pointer";
    default:
